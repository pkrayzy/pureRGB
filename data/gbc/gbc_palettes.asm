...
IF DEF(_RED)
	RGB 31,31,31, 31,12,00, 31,06,00, 23,03,03 ; PAL_LOGO1
ENDC
IF DEF(_BLUE)
	RGB 31,31,31, 14,19,29, 00,08,25, 03,03,23 ; PAL_LOGO1
ENDC
IF DEF(_GREEN)
	RGB 31,31,31, 03,15,05, 00,08,02, 03,23,03 ; PAL_LOGO1
ENDC
...
;;;;;;;;;; PureRGBnote: ADDED: new palettes used for various reasons
	...
	RGB 31,31,31, 31,31,00, 03,03,03, 03,03,03 ; PAL_ULTRABALL ; ultra ball palette when throwing one in battle
	...
	RGB 31,31,31, 16,21,31, 18,16,26, 03,03,03 ; PAL_PRISMATIC
;;;;;;;;;;
