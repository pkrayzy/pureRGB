...
IF DEF(_RED)
	RGB 31,29,31, 31,12,00, 31,06,00, 21,00,04 ; PAL_LOGO1
ENDC
IF DEF(_BLUE)
	RGB 31,29,31, 14,19,29, 00,08,25, 14,19,29 ; PAL_LOGO1
ENDC
IF DEF(_GREEN)
	RGB 31,29,31, 03,15,05, 00,08,02, 12,23,00 ; PAL_LOGO1 
ENDC
...
;;;;;;;;;; PureRGBnote: ADDED: new palettes used for various reasons
	...
	RGB 31,29,31, 21,24,27, 20,19,26, 03,02,02 ; PAL_PRISMATIC
;;;;;;;;;;
