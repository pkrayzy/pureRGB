	...
	const_export SEAFOAMISLANDSB4F_SCUBA1
	const_export SEAFOAMISLANDSB4F_SCUBA2
	const_export SEAFOAMISLANDSB4F_DRAGONAIR
...
SeafoamIslandsB4F_Object:
	...
	object_event 35,  1, SPRITE_NOTHING, STAY, DOWN, TEXT_SEAFOAMISLANDSB4F_SCUBA1
	object_event 35,  1, SPRITE_NOTHING, STAY, DOWN, TEXT_SEAFOAMISLANDSB4F_SCUBA2
	object_event 35,  7, SPRITE_SNAKE, STAY, DOWN, TEXT_SEAFOAMISLANDSB4F_DRAGONAIR
