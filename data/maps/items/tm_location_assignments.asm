...
DEF TM_ROUTE_12_GATE_2F_MOURNING_GIRL       EQU TM_SLAM 		; POISON JAB
...
DEF TM_ROUTE_24_RETURN_SHORTCUT_NEW         EQU TM_KINESIS 		; CRUNCH
...
DEF TM_SAFARI_ZONE_NORTH_NEAR_REST_HOUSE    EQU TM_SLAM 		; POISON JAB
