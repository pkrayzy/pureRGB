MapSongBanks::
	...
	db MUSIC_VERMILION, BANK(Music_Vermilion) ; VERMILION_FITNESS_CLUB
	db MUSIC_CITIES1, BANK(Music_Cities1) ; ROUTE_7_GATE
	db MUSIC_CITIES1, BANK(Music_Cities1) ; UNDERGROUND_PATH_ROUTE_7
	db MUSIC_CELADON, BANK(Music_Celadon) ; CELADON_BACK_ALLEY
	...
	db MUSIC_CINNABAR_MANSION, BANK(Music_CinnabarMansion) ; SAFARI_ZONE_CENTER_REST_HOUSE
	db MUSIC_CINNABAR_MANSION, BANK(Music_CinnabarMansion) ; SAFARI_ZONE_SECRET_HOUSE
	db MUSIC_CINNABAR_MANSION, BANK(Music_CinnabarMansion) ; SAFARI_ZONE_WEST_REST_HOUSE
	db MUSIC_CINNABAR_MANSION, BANK(Music_CinnabarMansion) ; SAFARI_ZONE_EAST_REST_HOUSE
	db MUSIC_CINNABAR_MANSION, BANK(Music_CinnabarMansion) ; SAFARI_ZONE_NORTH_REST_HOUSE
	...
	db MUSIC_CITIES2, BANK(Music_Cities2) ; CERULEAN_BALL_DESIGNER
