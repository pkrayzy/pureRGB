...
; Learnset
	db 13, GROWL
	db 15, FURY_SWIPES ; METAL CLAW
	db 19, DIG
	db 24, SAND_ATTACK
	db 30, SLAM ; POISON JAB
	db 35, SLASH
	db 39, EARTHQUAKE
	db 43, FURY_ATTACK
	db 49, DISABLE
...
; Learnset
	db 9, TAIL_WHIP
	db 18, KINESIS ; CRUNCH
	db 21, STOMP
	db 25, FOCUS_ENERGY
	db 28, HEADBUTT
	db 33, TAKE_DOWN ; FLAME CHARGE
	db 36, SWIFT
	db 40, FURY_ATTACK
	db 45, SKULL_BASH
	db 49, MEGA_KICK
