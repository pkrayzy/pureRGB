...
DEF NUM_HS_OBJECTS EQU const_value
	...
	const HS_CERULEAN_BALL_DESIGNER_CLIPBOARD ; 4F
	const HS_CERULEAN_BALL_DESIGNER_CAMERA ; 50
	const HS_CERULEAN_BALL_DESIGNER_CLIPBOARD2 ; 51
	const HS_VERMILIONFITNESSCLUB_CLERK ; 52
	const HS_VERMILIONFITNESSCLUB_MUSCLE1 ; 53
	const HS_VERMILIONFITNESSCLUB_JANITOR ; 54
